<template>
	<view class="content">
		<view class="title"><image class="titleImg" src="../../static/img/index/title.jpg" mode="scaleToFill"></image></view>
		<view class="treat">
		...
		<view class="treat">
			...
			<view class="grid">
				...
				<view class="grid-list" @click="login">
					<view class="grid-icon" style="background-color: #2899F5;">
		...
		<button type="default" @click="showcode">1234</button>
		<text>1111111111{{ text }}</text>
	</view>
</template>
...
export default {
	...
	onLoad(param) {
		...
		// if (param.code) {
			...
			this.text = authURL;
		// 	this.$u.get(
		// 		`https://api.weixin.qq.com/sns/oauth2/access_token?appid=wx5ec94806588674ae&secret=2008a05d0e71fecb7461957dfbcf9324&code=031wiCFa1fOfUz0K02Ja1zH0DH1wiCFJ&grant_type=authorization_code`,
		// 		{},
		// 		{
